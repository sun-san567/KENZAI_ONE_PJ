...
<div class="ml-64 w-[calc(50%-64px)] mx-auto py-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-xl font-bold text-gray-800">担当者編集</h1>
    </div>
    ...
    <div class="bg-white shadow-sm rounded-lg overflow-hidden border border-gray-200 p-6">
        <form action="{{ route('clients.contacts.update', [$client->id, $contact->id]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="position" id="position" class="w-full border-gray-300 rounded-md p-2 shadow-sm" 
            ...
            <div class="mb-4">
                ...
                <input type="tel" name="phone" id="phone" class="w-full border-gray-300 rounded-md p-2 shadow-sm" 
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" id="email" class="w-full border-gray-300 rounded-md p-2 shadow-sm" 
            ...
            <div class="mb-4">
                ...
                <textarea name="note" id="note" rows="3" class="w-full border-gray-300 rounded-md p-2 shadow-sm">{{ old('note', $contact->note) }}</textarea>
            </div>
