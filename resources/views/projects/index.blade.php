    ...
    <div class="bg-white rounded-lg shadow-sm p-5 mb-6" x-data="{ 
        ...
        <form action="{{ route('projects.index') }}" method="GET">
            ...
            <div class="flex flex-col md:flex-row gap-3 items-end">
                <div class="flex-grow">
                    <label for="search_name" class="block text-sm font-medium text-gray-700 mb-1">プロジェクト名・取引先名で検索</label>
            ...
            <div x-show="showAdvanced"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    ...
                    <div>
                        ...
                        <input type="date" id="search_estimate_deadline" name="search_estimate_deadline"
